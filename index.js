...
inquirer
   ...
   .then(answers => {
       ...
       Axios.all ([
        Axios.get(queryUrl),
        Axios.get(starsQuery)

       ])
           .then(Axios.spread((gitResponse, starResponse) => {

            //console.log(gitResponse.data)
            
            starArray = starResponse.data
                        ...
                        <div class="container-fluid">
                            <div class="container main-div">
                                <div class="container pdf-header">
                                    ...
                                    <div class="row">
                                        <img id="ProfileImg" src="${gitResponse.data.avatar_url}">
                                    ...
                                    <div class="row">
                                        ...
                                        <div class="col-md-4 bio">
                                            <p>Hi! My name is ${gitResponse.data.name}</p> 
                                            <p>${gitResponse.data.bio}</p>
                                        </div>
                                ...
                                <div class="row">
                                    <div class="col-md-4 location">${gitResponse.data.location}</div>
                                    <div class="col-md-4 githublink"><a id="GithubLink" href="${gitResponse.data.html_url}">Github</a></div>
                                    <div class="col-md-4 githublink"><a id="GithubLink" href="${gitResponse.data.blog}">Blog</a></div>
                                </div>
                            ...
                            <div class="container pdf-header">
                                <div class="row">
                                    <div class="col-md-2 followers">
                                        <p>Followers</p>
                                        <p>${gitResponse.data.followers}</p>
                                    </div>
                                    <div class="col-md-2 following">
                                        <p>Following</p>
                                        <p>${gitResponse.data.following}</p>
                                    </div>
                                </div>
                                ...
                                <div class="row">
                                    <div class="col-md-2 stars">
                                        <p>Stars</p>
                                        <p>${starArray.length}</p>
                                    </div>
                                    <div class="col-md-2 repos">
                                        <p>Repositories</p>
                                        <p>${gitResponse.data.public_repos}</p>
                                    </div>
                                </div>
                                </div>
                            </div>
